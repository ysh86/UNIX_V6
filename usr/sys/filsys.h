...
struct	filsys
{
	...
	short	s_nfree;	/* number of in core free blocks (0-100) */
	short	s_free[100];	/* in core free blocks */
	short	s_ninode;	/* number of in core I nodes (0-100) */
	...
	short	pad[40];
	short	s_tfree;	/* Total free, for subsystem examination */
	short	s_tinode;	/* Free inodes, for subsystem examination */
